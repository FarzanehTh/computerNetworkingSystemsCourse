...
time=60
bwnet=10
# Given RTT is 4ms, the delay on each link is 1 ms.
delay=1
...
for qsize in 5 20 100; do
    ...
    python plot_ping.py -f $dir/ping.txt -o $dir/rtt-$qsize.png -d $dir/download_time.txt -do $dir/download-$qsize.png
done
